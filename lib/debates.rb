...
class Debates
  # Example:
  # Debates.new.debates_from_url(:commons, "http://www.publications.parliament.uk/pa/cm201314/cmhansrd/cm130521/debtext/130521-0002.htm")
  ...
  def debate_from_url(type, url)
    ...
    client.debate(type: type.to_s, gid: gid)
    # API Definition:
    # getDebates: {
    #   require: :type,
